...
public class AbstractShiroWebConfiguration extends AbstractShiroConfiguration {
    ...
    //DefaultAppConfigInitializer supports decrypting feature
    @Value("#{ @environment['shiro.rememberMeManager.cipherKey.'] ?: null }")
    protected String rememberMeManagerCipherKey;
    ...
    protected RememberMeManager rememberMeManager() {
        ...
        if (StringUtils.isNotEmpty(this.rememberMeManagerCipherKey)) {
            cookieRememberMeManager.setCipherKey(this.rememberMeManagerCipherKey.getBytes(StandardCharsets.UTF_8));
        }
