...
<head>
    ...
    <c:import url="head.jsp">
        <c:param name="title" value="INSPINIA | Dashboard"/>
    </c:import>
    ...
    <!-- Toastr style -->
    <link href="<spring:url value="/css/plugins/toastr/toastr.min.css" />" rel="stylesheet">

    <!-- Gritter -->
    <link href="<spring:url value="/js/plugins/gritter/jquery.gritter.css" />" rel="stylesheet">
...
<!-- Mainly scripts -->
<script src="<spring:url value="/js/jquery-3.1.1.min.js" />"></script>
...
<script src="<spring:url value="/js/plugins/slimscroll/jquery.slimscroll.min.js" />"></script>

<!-- Flot -->
<script src="<spring:url value="/js/plugins/flot/jquery.flot.js" />"></script>
<script src="<spring:url value="/js/plugins/flot/jquery.flot.tooltip.min.js" />"></script>
<script src="<spring:url value="/js/plugins/flot/jquery.flot.spline.js" />"></script>
<script src="<spring:url value="/js/plugins/flot/jquery.flot.resize.js" />"></script>
<script src="<spring:url value="/js/plugins/flot/jquery.flot.pie.js" />"></script>

<!-- Peity -->
<script src="<spring:url value="/js/plugins/peity/jquery.peity.min.js" />"></script>
<script src="<spring:url value="/js/demo/peity-demo.js" />"></script>

<!-- Custom and plugin javascript -->
<script src="<spring:url value="/js/inspinia.js" />"></script>
<script src="<spring:url value="/js/plugins/pace/pace.min.js" />"></script>

<!-- jQuery UI -->
<script src="<spring:url value="/js/plugins/jquery-ui/jquery-ui.min.js" />"></script>

<!-- GITTER -->
<script src="<spring:url value="/js/plugins/gritter/jquery.gritter.min.js" />"></script>

<!-- Sparkline -->
<script src="js/plugins/sparkline/jquery.sparkline.min.js"></script>

<!-- Sparkline demo data  -->
<script src="<spring:url value="/js/demo/sparkline-demo.js" />"></script>

<!-- ChartJS-->
<script src="<spring:url value="/js/plugins/chartJs/Chart.min.js" />"></script>

<!-- Toastr -->
<script src="<spring:url value="/js/plugins/toastr/toastr.min.js" />"></script>
